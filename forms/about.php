  ...
  <body>
    ...
    <row id="info" class="d-flex bd-highlight mb-3">
      <div id="about" class="col-md-4 mr-auto p-2 bd-highlight">
        <p>
          <span id="o-apa">ও আপা!</span>
        </p>

        <p></p><br>
        <p>
          O APA! is a web-application based on Maid and BabySitter Service.
          Currenty this service is ongoing inside Bashundhara,Dhaka.
        </p>
      </div>
      ...
      <div id="infos" class="col-md-4 p-2 bd-highlight">
        <ul>
          ...
          <li>
            ...
            <span id="location"
              >AIUB , 408/1, Kuratoli, Khilkhet, Dhaka 1229, Bangladesh</span
            >
          </li>
          <li>
